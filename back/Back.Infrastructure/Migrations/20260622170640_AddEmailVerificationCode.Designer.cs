...
namespace Back.Infrastructure.Migrations
{
    ...
    [Migration("20260622170640_AddEmailVerificationCode")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Back.Domain.Entities.Aluno.Aluno", b =>
                {
                    ...
                    b.Property<bool>("NotificadoSecretariaComplementar")
                        .HasColumnType("boolean");

                    b.Property<bool>("NotificadoSecretariaExtensao")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Back.Domain.Entities.Atividade.Atividade", b =>
                {
                    ...
                    b.Property<int?>("HorasCurricularizacaoExtensao")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("PossuiCurricularizacaoExtensao")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Back.Domain.Entities.Auth.EmailVerificationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Back.Domain.Entities.Auth.ResetPasswordCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IdentityUserId", "Code", "Used");

                    b.ToTable("ResetPasswordCodes", (string)null);
                });

            modelBuilder.Entity("Back.Domain.Entities.Campus.Campus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Back.Domain.Entities.Certificado.Certificado", b =>
                {
                    ...
                    b.Property<string>("AnexoStorageKey")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("CargaHorariaCorrigida")
                        .HasColumnType("boolean");

                    b.Property<int?>("CargaHorariaOriginal")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Back.Domain.Entities.Curso.Curso", b =>
                {
                    ...
                    b.Property<int>("DuracaoEmPeriodos")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Back.Domain.Entities.LembreteEmail.LembreteEmail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Back.Domain.Entities.Curso.Curso", b =>
                {
                    b.HasOne("Back.Domain.Entities.Campus.Campus", "Campus")
                        .WithMany("Cursos")
            ...
            modelBuilder.Entity("Back.Domain.Entities.LembreteEmail.LembreteEmail", b =>
                {
                    b.HasOne("Back.Domain.Entities.Curso.Curso", null)
                        .WithMany()
                        .HasForeignKey("CursoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
